...
export const CENTER_MAP_SYSTEMS: CenterMapSystem[] = [
  ...
  { key: "hoot", label: "HOOT", left: 61, top: 28, width: 8, height: 24 },
  { key: "m-bio", label: "M-BIO", left: 74, top: 28, width: 8, height: 24 },
  { key: "delta", label: "DELTA", left: 61.5, top: 63, width: 8, height: 24 },
  { key: "cl", label: "CL", left: 74.5, top: 63, width: 8, height: 24 },
];
